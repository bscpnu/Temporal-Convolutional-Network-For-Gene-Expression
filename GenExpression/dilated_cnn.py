...
if __name__=='__main__':
    ...
    o = TCN(nb_filters=128, kernel_size=1, return_sequences=True, padding='causal', use_skip_connections=True, name='TCN_1')(i)  # The TCN layers are here.
    o = TCN(nb_filters=64,kernel_size=1, padding='causal', return_sequences=True, use_skip_connections=True, name='TCN_2')(o)  # The TCN layers are here.
    o = TCN(nb_filters=32, kernel_size=2, padding='causal', use_skip_connections=True, return_sequences=False, name='TCN_3')(o)  # The TCN layers are here.
    o = Dense(200, activation='relu', kernel_regularizer=regularizers.l2(0.25), bias_regularizer=regularizers.l1(0.25))(o)
    o = Dense(100, activation='relu',kernel_regularizer=regularizers.l2(0.25), bias_regularizer=regularizers.l1(0.25))(o)
    o = Dense(2, activation='softmax')(o)
    m = Model(inputs=[i], outputs=[o])
    m.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])

    history = m.fit(x_train, train_y, epochs=5, validation_split=0.2)
    ...
    plt.title('Confusion Matrix of Temporal Covolutional Network - Test Data')
