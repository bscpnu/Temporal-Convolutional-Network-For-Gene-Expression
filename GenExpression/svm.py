...
if __name__=='__main__':
    ...
    svm.fit(x_train, train_y_ori)

    predicted = svm.predict(x_test)

    cm = confusion_matrix(test_y_ori, predicted)
    plt.clf()
    ...
    # calculate AUC
    auc = roc_auc_score(test_y_ori, predicted)
    print('AUC: %.3f' % auc)

    # calculate roc curve
    fpr, tpr, thresholds = roc_curve(test_y_ori, predicted)
    ...
    acc = accuracy_score(test_y_ori, predicted)
